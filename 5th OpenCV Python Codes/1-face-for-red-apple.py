...
cv2.imwrite("Output/My_lip.jpg", fit_lip)
cv2.imwrite("Output/My_right_eye.jpg", fit_right_eye)
cv2.imwrite("Output/My_left_eye.jpg", fit_left_eye)
...
cv2.imshow("lip", fit_lip)
cv2.imshow("R", fit_right_eye)
cv2.imshow("L", fit_left_eye)
cv2.imshow("apple", red_apple)
cv2.imshow("M", mask)
cv2.waitKey()
#cv2.imwrite("Output/My_mask.jpg", mask)
cv2.imwrite("Output/My_face_for_red_apple.jpg", red_apple)